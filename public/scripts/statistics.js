...
const refreshStatistics = async () => {
    ...
    authorsNum.innerHTML = `${data.authorsNum} автор қосылды`;
    poemsNum.innerHTML = `${data.poemsNum} өлең қосылды`;
    linesNum.innerHTML = `${data.linesNum} тармақ қосылды`;
    annotationsNum.innerHTML = `${data.annotationsNum} аннотация қосылды`;
