...
# Акындар[![kk](https://img.shields.io/badge/lang-kk-blue.svg)](./README.md)[![en](https://img.shields.io/badge/lang-en-yellow.svg)](./README.en.md)[![ru](https://img.shields.io/badge/lang-ru-red.svg)](./README.ru.md)

Передать стихи казахских писателей и поэтов понятным языком.

[Прочтите документацию](https://github.com/nuromirzak/aqyndar)·[Сообщить об ошибке](https://github.com/nuromirzak/aqyndar/issues)·[Предложить изменение](https://github.com/nuromirzak/aqyndar/issues)
...
2.  [Начало работы над проектом](#проектке-кірісу)
    -   [Предварительные условия](#алғышарттар)
    -   [Монтаж](#орнату)
3.  [Добавить вклад](#үлес-қосу)
4.  [Лицензия](#лицензия)
5.  [Контакты](#контакттер)
...
Цель этого сайта – донести до общественности стихи казахских писателей и поэтов на понятном языке. Этот
...
Выполните следующие простые шаги, чтобы запустить проект на своем компьютере.
...
4.  Переменные среды`.env`войти в файл
...
Благодаря вкладу сообщество открытого исходного кода становится прекрасным местом для обучения, вдохновения и выдвижения новых идей. Любой
ваш вклад**высоко оценен**.

Если у вас есть предложение по улучшению этого проекта, создайте форк репозитория и откройте запрос на включение. Ты
Вы также можете перейти на страницу «Проблемы» и отправить свои предложения. Не забудьте поставить звездочку проекту! Большое спасибо!
